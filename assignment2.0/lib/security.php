...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "query1.php";
     $whiteListPages[] = "query2.php";
   ...
   $whiteListPages[] = "q05.php";
    ...
    $whiteListFolders[] = "/cs148/assignment2.0/query1.php";
    $whiteListFolders[] = "/cs148/assignment2.0/select.php";
    $whiteListFolders[] = "/cs148develop/assignment2.0/query1.php";
    $whiteListFolders[] = "/cs148develop/assignment2.0/query2.php";
    $whiteListFolders[] = "/cs148develop/assignment2.0/index.php";
